...
from users.serializer import UserAdminSerializer, UserSerializer, PasswordResetRequestSerializer, \
...
class PasswordResetRequestView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({'detail': 'Пользователя с таким email нет'},
        ...
        return Response({'detail': 'На Вашу почту отправлено сообщение для обновления пароля'},
    ...
    def post(self, request):
        ...
        try:
            ...
            if reset_token.is_valid():
                ...
                return Response({'detail': 'Не действительный токен восстановления'},
                                status=status.HTTP_400_BAD_REQUEST)

        except (User.DoesNotExist, PasswordResetToken.DoesNotExist):
            return Response({'detail': 'Не существует такого пользователя или токен не действителен'},
                            status=status.HTTP_400_BAD_REQUEST)
