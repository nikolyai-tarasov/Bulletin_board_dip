...
from board.views import (
    AdListAPIView, AdRetrieveAPIView, AdDestroyAPIView,
    AdCreateAPIView, AdUpdateAPIView, ReviewListAPIView,
    ReviewUpdateAPIView, ReviewCreateAPIView,
    ReviewDestroyAPIView, ReviewRetrieveAPIView
)
...
urlpatterns = [
    ...
    path("retrieve_review/<int:pk>/", ReviewRetrieveAPIView.as_view(), name="retrieve_review"),
    path("update_review/<int:pk>/", ReviewUpdateAPIView.as_view(), name="update_review"),
    path("destroy_review/<int:pk>/", ReviewDestroyAPIView.as_view(), name="destroy_review"),
]
